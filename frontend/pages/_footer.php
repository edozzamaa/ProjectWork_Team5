...
<div class="modal fade" id="modalConfirmDel" tabindex="-1" aria-labelledby="titleConfirmDel" aria-hidden="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-danger text-white">
                <h2 class="modal-title fs-5" id="titleConfirmDel"><i class="bi bi-exclamation-triangle-fill me-2"></i>Conferma eliminazione</h2>
