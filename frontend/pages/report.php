...
<h1 class="section-title mb-4" id="titoloReport"><i class="bi bi-graph-up me-2"></i>Report</h1>
    ...
    <div class="col-lg-6">
        <article class="card shadow-sm h-100" aria-labelledby="titoloSoglia">
            <header class="card-header fw-semibold d-flex justify-content-between align-items-center">
                <span id="titoloSoglia"><i class="bi bi-exclamation-triangle-fill text-danger me-2"></i>Prodotti sotto soglia di riordino</span>
...
<article class="card shadow-sm mb-4" aria-labelledby="titoloGiacenze">
    <header class="card-header fw-semibold d-flex justify-content-between align-items-center">
        <span id="titoloGiacenze"><i class="bi bi-table me-2"></i>Giacenze dettagliate per posizione</span>
...
<article class="card shadow-sm mb-4" aria-labelledby="titoloCompleto">
    <header class="card-header fw-semibold d-flex justify-content-between align-items-center">
        <span id="titoloCompleto"><i class="bi bi-file-earmark-text me-2"></i>Report completo prodotti</span>
                <div class="d-flex gap-2">
